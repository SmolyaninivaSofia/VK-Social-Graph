...
from vk_api_folder import jconfig
...
class VkApi(object):
    ...
    (включая :class:`vk_api_folder.audio.VkAudio`)
    ...
    def __init__(self, login=None, password=None, token=None,
        ...
        self.logger = logging.getLogger('vk_api_folder')
    ...
    def _vk_login(self, captcha_sid=None, captcha_key=None):
        ...
        if self._sid:
            ...
            raise AuthError(
                'Unknown error. Please send bugreport to vk_api_folder@python273.pw'
            )
